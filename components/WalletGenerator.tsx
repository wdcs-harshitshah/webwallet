              ...
              >
                <div className="flex flex-col gap-2">
                  <h1 className="tracking-tighter text-4xl md:text-5xl font-black">
                    This Web 3 Wallet supports multiple blockchains
                  </h1>
      ...
      {wallets.length > 0 && (
        ...
        >
          ...
          <div className="flex w-full justify-between items-center">
            ...
            <div className="flex gap-2">
              <Button onClick={handleClearWallets} variant="destructive">
                <Trash className="mr-2 h-5 w-5" /> Clear All Wallets
              </Button>
